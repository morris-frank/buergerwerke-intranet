...
Cooperative.create!(email: 'info@heg.de', address: 'Eppelheim', name: 'Heidelberger Energiegenossenschaft', latitude: 49.4075, longitude: 8.6447, website: 'https://hd-eeg.de', coopnumber: 'M01') if Rails.env.development?
...
Cooperative.create!(email: 'info@eeg.de', address: 'Entenhausen', name: 'Entenhausener Energiegenossenschaft', latitude: 53.28407, longitude: 9.75958, website: 'https://entenhausen.com', coopnumber: 'P01') if Rails.env.development?
